        ...
        <fieldset class="border border-dark p-3 rounded" style="background-color: lightyellow;">
            ...
            <div class="form-group row">
                ...
                <div class="input-group">
                    ...
                    <input id="nim" name="nim" placeholder="*0110224015" type="text" class="form-control" required="required" pattern="[0-9]{10}" title="NIM harus 10 Digit Angka">
                </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="input-group">
                    ...
                    <input id="nama_lengkap" name="nama_lengkap" placeholder="*Luffy" type="text" class="form-control" required="required" minlenght="3" maxlenght="50">
                </div>
                </div>
            </div>
            <div class="form-group row">
